...
// checks if the ConfigDeactivated type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConfigDeactivated{}
...
func (o ConfigDeactivated) ToMap() (map[string]interface{}, error) {
