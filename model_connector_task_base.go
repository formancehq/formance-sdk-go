...
// checks if the ConnectorTaskBase type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorTaskBase{}
...
func (o ConnectorTaskBase) ToMap() (map[string]interface{}, error) {
