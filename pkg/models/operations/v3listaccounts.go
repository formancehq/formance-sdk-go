...
var V3ListAccountsServerList = []string{
	"http://localhost:8080/",
}
...
// #endregion class-body-v3listaccountsrequest
...
type V3ListAccountsResponse struct {
	...
	// OK
	V3AccountsCursorResponse *payments.V3AccountsCursorResponse
}
...
func (v *V3ListAccountsResponse) GetV3AccountsCursorResponse() *payments.V3AccountsCursorResponse {
	if v == nil {
		return nil
	}
...
// #region class-body-v3listaccountsresponse
// #endregion class-body-v3listaccountsresponse
