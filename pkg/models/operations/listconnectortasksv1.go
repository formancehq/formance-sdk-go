...
func (l *ListConnectorTasksV1Request) GetConnector() payments.Connector {
	if l == nil {
...
func (l *ListConnectorTasksV1Response) GetTasksCursor() *payments.TasksCursor {
	if l == nil {
		return nil
	}
