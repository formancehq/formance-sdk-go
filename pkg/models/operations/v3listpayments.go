...
func (v *V3ListPaymentsRequest) GetPageSize() *int64 {
	if v == nil {
		return nil
	}
	return v.PageSize
...
func (v *V3ListPaymentsResponse) GetStatusCode() int {
	if v == nil {
		return 0
	}
	return v.StatusCode
...
func (v *V3ListPaymentsResponse) GetRawResponse() *http.Response {
	if v == nil {
		return nil
	}
...
func (v *V3ListPaymentsResponse) GetV3PaymentsCursorResponse() *payments.V3PaymentsCursorResponse {
	...
	return v.V3PaymentsCursorResponse
}

// #region class-body-v3listpaymentsresponse
// #endregion class-body-v3listpaymentsresponse
