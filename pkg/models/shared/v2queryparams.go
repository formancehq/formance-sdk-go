...
type V2QueryParamsSchemasTrue4Resource string

const (
	V2QueryParamsSchemasTrue4ResourceVolumes V2QueryParamsSchemasTrue4Resource = "volumes"
)

func (e V2QueryParamsSchemasTrue4Resource) ToPointer() *V2QueryParamsSchemasTrue4Resource {
	return &e
}
func (e *V2QueryParamsSchemasTrue4Resource) UnmarshalJSON(data []byte) error {
	var v string
	...
	switch v {
	case "volumes":
		*e = V2QueryParamsSchemasTrue4Resource(v)
		return nil
	default:
		return fmt.Errorf("invalid value for V2QueryParamsSchemasTrue4Resource: %v", v)
	}
}
...
type QueryTemplateVolumeParams struct {
	...
	Resource *V2QueryParamsSchemasTrue4Resource `json:"resource,omitempty"`
...
func (q *QueryTemplateVolumeParams) GetResource() *V2QueryParamsSchemasTrue4Resource {
	if q == nil {
		return nil
	}
	return q.Resource
