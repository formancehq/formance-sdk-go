...
// checks if the CreateTransaction409Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTransaction409Response{}
...
func (o CreateTransaction409Response) ToMap() (map[string]interface{}, error) {
