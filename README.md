...
*DefaultApi* | [**GetServerInfo**](docs/DefaultApi.md#getserverinfo) | **Get** /api/search/_info | Get server info
...
## Documentation For Models
 ...
 - [TaskDescriptorBankingCircleAllOf](docs/TaskDescriptorBankingCircleAllOf.md)
 - [TaskDescriptorBankingCircleAllOfDescriptor](docs/TaskDescriptorBankingCircleAllOfDescriptor.md)
 - [TaskDescriptorCurrencyCloud](docs/TaskDescriptorCurrencyCloud.md)
 - [TaskDescriptorCurrencyCloudAllOf](docs/TaskDescriptorCurrencyCloudAllOf.md)
 - [TaskDescriptorCurrencyCloudAllOfDescriptor](docs/TaskDescriptorCurrencyCloudAllOfDescriptor.md)
 - [TaskDescriptorDummyPay](docs/TaskDescriptorDummyPay.md)
 - [TaskDescriptorDummyPayAllOf](docs/TaskDescriptorDummyPayAllOf.md)
 - [TaskDescriptorDummyPayAllOfDescriptor](docs/TaskDescriptorDummyPayAllOfDescriptor.md)
 - [TaskDescriptorModulr](docs/TaskDescriptorModulr.md)
 - [TaskDescriptorModulrAllOf](docs/TaskDescriptorModulrAllOf.md)
 - [TaskDescriptorModulrAllOfDescriptor](docs/TaskDescriptorModulrAllOfDescriptor.md)
 - [TaskDescriptorStripe](docs/TaskDescriptorStripe.md)
 - [TaskDescriptorStripeAllOf](docs/TaskDescriptorStripeAllOf.md)
 - [TaskDescriptorStripeAllOfDescriptor](docs/TaskDescriptorStripeAllOfDescriptor.md)
 - [TaskDescriptorWise](docs/TaskDescriptorWise.md)
 - [TaskDescriptorWiseAllOf](docs/TaskDescriptorWiseAllOf.md)
 - [TaskDescriptorWiseAllOfDescriptor](docs/TaskDescriptorWiseAllOfDescriptor.md)
