...
*WalletsApi* | [**ConfirmHold**](docs/WalletsApi.md#confirmhold) | **Post** /api/wallets/wallets/{id}/holds/{hold_id}/confirm | Confirm a hold
...
*WalletsApi* | [**GetHolds**](docs/WalletsApi.md#getholds) | **Get** /api/wallets/wallets/{id}/holds | Get all holds for a wallet
*WalletsApi* | [**GetWallet**](docs/WalletsApi.md#getwallet) | **Get** /api/wallets/wallets/{id} | Get a wallet
*WalletsApi* | [**GetWallets**](docs/WalletsApi.md#getwallets) | **Get** /api/wallets/wallets | Get all wallets
*WalletsApi* | [**UpdateWallet**](docs/WalletsApi.md#updatewallet) | **Patch** /api/wallets/wallets/{id} | Update a wallet
*WalletsApi* | [**VoidHold**](docs/WalletsApi.md#voidhold) | **Post** /api/wallets/wallets/{id}/holds/{hold_id}/void | Cancel a hold
