...
// checks if the WalletWithBalancesAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WalletWithBalancesAllOf{}
...
func (o WalletWithBalancesAllOf) ToMap() (map[string]interface{}, error) {
