...
// checks if the GetBalancesAggregated200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetBalancesAggregated200Response{}
...
func (o GetBalancesAggregated200Response) ToMap() (map[string]interface{}, error) {
