...
// checks if the GetAccount400Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAccount400Response{}
...
func (o GetAccount400Response) ToMap() (map[string]interface{}, error) {
