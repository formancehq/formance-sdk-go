...
func newFormanceWebhooksV1(rootSDK *Formance, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *FormanceWebhooksV1 {
...
// GetDeliveries - List webhook deliveries
//
// If set, this operation will use [Security.ClientID] from the global security.
func (s *FormanceWebhooksV1) GetDeliveries(ctx context.Context, request operations.GetDeliveriesRequest, opts ...operations.Option) (*operations.GetDeliveriesResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := url.JoinPath(baseURL, "/api/webhooks/deliveries")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetDeliveriesResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out webhooks.DeliveriesResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.DeliveriesResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
// GetDelivery - Get a webhook delivery
//
// If set, this operation will use [Security.ClientID] from the global security.
func (s *FormanceWebhooksV1) GetDelivery(ctx context.Context, request operations.GetDeliveryRequest, opts ...operations.Option) (*operations.GetDeliveryResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/api/webhooks/deliveries/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetDeliveryResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out webhooks.DeliveryResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.DeliveryResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
// GetDeliveryAttempts - List attempts for a webhook delivery
//
// If set, this operation will use [Security.ClientID] from the global security.
func (s *FormanceWebhooksV1) GetDeliveryAttempts(ctx context.Context, request operations.GetDeliveryAttemptsRequest, opts ...operations.Option) (*operations.GetDeliveryAttemptsResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/api/webhooks/deliveries/{id}/attempts", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetDeliveryAttemptsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out webhooks.DeliveryAttemptsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.DeliveryAttemptsResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
// ReplayDeliveries - Replay a page of failed or pending deliveries
//
// If set, this operation will use [Security.ClientID] from the global security.
func (s *FormanceWebhooksV1) ReplayDeliveries(ctx context.Context, request operations.ReplayDeliveriesRequest, opts ...operations.Option) (*operations.ReplayDeliveriesResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := url.JoinPath(baseURL, "/api/webhooks/deliveries/replay")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "ReplayDeliveriesRequest", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.ReplayDeliveriesResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out webhooks.ReplayDeliveriesResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ReplayDeliveriesResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
// ReplayDelivery - Replay one failed or pending delivery
//
// If set, this operation will use [Security.ClientID] from the global security.
func (s *FormanceWebhooksV1) ReplayDelivery(ctx context.Context, request operations.ReplayDeliveryRequest, opts ...operations.Option) (*operations.ReplayDeliveryResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/api/webhooks/deliveries/{id}/replay", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.ReplayDeliveryResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
