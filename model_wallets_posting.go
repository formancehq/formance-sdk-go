...
// checks if the WalletsPosting type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WalletsPosting{}
...
func (o WalletsPosting) ToMap() (map[string]interface{}, error) {
