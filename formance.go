...
func New(opts ...SDKOption) *Formance {
	sdk := &Formance{
		sdkConfiguration: sdkConfiguration{
			Language:          "go",
			OpenAPIDocVersion: "v2.0.0-rc.1",
			SDKVersion:        "v2.0.0-rc.1",
			GenVersion:        "2.237.2",
			UserAgent:         "speakeasy-sdk/go v2.0.0-rc.1 2.237.2 v2.0.0-rc.1 github.com/formancehq/formance-sdk-go/v2",
		},
	}
