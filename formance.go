...
// Generated from OpenAPI doc version SDK_VERSION and generator version 2.879.6
...
func New(opts ...SDKOption) *Formance {
	sdk := &Formance{
		SDKVersion: "3.9.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 3.9.0 2.879.6 SDK_VERSION github.com/formancehq/formance-sdk-go/v3",
		},
		hooks: hooks.New(),
	}
