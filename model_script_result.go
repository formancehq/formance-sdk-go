...
// checks if the ScriptResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScriptResult{}
...
func (o ScriptResult) ToMap() (map[string]interface{}, error) {
