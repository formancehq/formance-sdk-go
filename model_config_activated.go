...
// checks if the ConfigActivated type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConfigActivated{}
...
func (o ConfigActivated) ToMap() (map[string]interface{}, error) {
