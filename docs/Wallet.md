...
**Balances** | **map[string]float32** | The balances of the wallet. | 
**Name** | **string** |  | 
...
`func NewWallet(id string, metadata map[string]interface{}, balances map[string]float32, name string, ) *Wallet`
...
`func (o *Wallet) GetBalances() map[string]float32`

GetBalances returns the Balances field if non-nil, zero value otherwise.

### GetBalancesOk

`func (o *Wallet) GetBalancesOk() (*map[string]float32, bool)`
...
`func (o *Wallet) SetBalances(v map[string]float32)`
