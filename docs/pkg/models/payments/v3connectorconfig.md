...
```go
v3ConnectorConfig := shared.CreateV3ConnectorConfigV3BankingbridgeConfig(payments.V3BankingbridgeConfig{/* values here */})
```

### V3BitstampConfig

```go
v3ConnectorConfig := shared.CreateV3ConnectorConfigV3BitstampConfig(payments.V3BitstampConfig{/* values here */})
```
...
```go
v3ConnectorConfig := shared.CreateV3ConnectorConfigV3RoutableConfig(payments.V3RoutableConfig{/* values here */})
```
