...
```go
v2LogData := shared.CreateV2LogDataV2LogDataNewTransaction(ledger.V2LogDataNewTransaction{/* values here */})
```

### V2LogDataSetMetadata

```go
v2LogData := shared.CreateV2LogDataV2LogDataSetMetadata(ledger.V2LogDataSetMetadata{/* values here */})
```

### V2LogDataRevertedTransaction

```go
v2LogData := shared.CreateV2LogDataV2LogDataRevertedTransaction(ledger.V2LogDataRevertedTransaction{/* values here */})
```

### V2LogDataDeleteMetadata

```go
v2LogData := shared.CreateV2LogDataV2LogDataDeleteMetadata(ledger.V2LogDataDeleteMetadata{/* values here */})
```

### V2LogDataInsertedSchema

```go
v2LogData := shared.CreateV2LogDataV2LogDataInsertedSchema(ledger.V2LogDataInsertedSchema{/* values here */})
```
