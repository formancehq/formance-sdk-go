...
value := orchestration.StageSendDestinationPaymentTypeTransfer
```
...
| Name                                      | Value                                     |
| ----------------------------------------- | ----------------------------------------- |
| `StageSendDestinationPaymentTypeTransfer` | TRANSFER                                  |
| `StageSendDestinationPaymentTypePayout`   | PAYOUT                                    |